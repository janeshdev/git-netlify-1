...
Let us use the link `https://t.co/l8ZhhzAytA` from the above dataframe to extract the link. 
...
has the image download link that we are intested. I am going to use the 5th element 
